//
// Created by star on 14.2.2023.
//

#ifndef MIDI_SYNTH_MESSAGES_H
#define MIDI_SYNTH_MESSAGES_H

// Define what the fuck the function byte is supposed to be, but i have no idea whats going on with this
