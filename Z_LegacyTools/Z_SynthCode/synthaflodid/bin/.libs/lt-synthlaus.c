...
/* ./bin/.libs/lt-synthlaus.c - temporary wrapper executable for .libs/synthlaus
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1

   The ./bin/synthlaus program cannot be directly executed until all the libtool
...
const char * EXE_PATH_VALUE   = "C;C:\\MinGW\\msys\\1.0\\Project\\Synthar\\InterSynth\\Z_LegacyTools\\rtmidi\\lib;C;C:\\MinGW\\msys\\1.0\\Project\\Synthar\\InterSynth\\Z_LegacyTools\\rtmidi\\bin;C;C:\\MinGW\\msys\\1.0\\Project\\Synthar\\InterSynth\\Z_LegacyTools\\portaudio\\lib;C;C:\\MinGW\\msys\\1.0\\Project\\Synthar\\InterSynth\\Z_LegacyTools\\portaudio\\bin;C;C:\\MinGW\\msys\\1.0\\Project\\Synthar\\InterSynth\\Z_LegacyTools\\freeglut\\lib;C;C:\\MinGW\\msys\\1.0\\Project\\Synthar\\InterSynth\\Z_LegacyTools\\freeglut\\bin;";
const char * TARGET_PROGRAM_NAME = "synthlaus"; /* hopefully, no .exe */
...
main (int argc, char *argv[])
{
  ...
  lt_debugprintf (__FILE__, __LINE__, "libtool wrapper (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n");
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# ./bin/synthlaus - temporary wrapper script for .libs/synthlaus\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.7ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The ./bin/synthlaus program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"synthlaus:./bin/synthlaus:${LINENO}: libtool wrapper (GNU libtool) 2.", f);
  fputs ("4.2 Debian-2.4.2-1.7ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"synthlaus:./bin/synthlaus:${LINENO}: newargv[$lt_dump_args_N]: $lt_a", f);
  fputs ("rg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"synthlaus:./bin/synthlaus:${LINENO}: newargv[0]: $progdir/$progr", f);
  fputs ("am\" 1>&2\n", f);
  ...
  fputs ("    PATH=C:/Project/Synthar/InterSynth/Z_LegacyTools/rtmidi/lib:C:/Project/Synt", f);
  fputs ("har/InterSynth/Z_LegacyTools/rtmidi/bin:C:/Project/Synthar/InterSynth/Z_LegacyT", f);
  fputs ("ools/portaudio/lib:C:/Project/Synthar/InterSynth/Z_LegacyTools/portaudio/bin:C:", f);
  fputs ("/Project/Synthar/InterSynth/Z_LegacyTools/freeglut/lib:C:/Project/Synthar/Inter", f);
  fputs ("Synth/Z_LegacyTools/freeglut/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    if test \"$libtool_execute_magic\" != \"%%%MAGIC variable%%%\"; then\n", f);
